...
<input type="image" src="https://www.paypalobjects.com/en_US/i/btn/btn_donate_LG.gif" border="1" name="submit" title="Eine kleine Spende für den nächsten Satz Propeller" alt="Donate with PayPal button" />
